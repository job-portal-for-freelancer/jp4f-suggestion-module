...
# updated_info = qdrant_client.get_collection("jp4f-vector-db")
# print(updated_info.dict())
...
#     collection_name="jp4f-vector-db",
#     vectors_config={
#         "my_vector": VectorParams(
#             size=1024,  # Specify the vector dimension size
#             distance="Cosine",  # Choose distance metric: "Cosine", "Euclid", or "Dot"
#             on_disk=True  # Store vectors on disk if needed
#         )
#     }
# )
